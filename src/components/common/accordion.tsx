...
export const Collapse: React.FC<CollapseProps> = ({
  ...
  const t = useTranslations(translatorNS);
  return (
    <div
      className={cn({
    ...
    >
      ...
      >
        <h2
          className={cn('text-sm font-semibold leading-relaxed text-heading ltr:pr-2 rtl:pl-2', {
...
const Accordion: React.FC<AccordionProps> = ({ items, translatorNS, variant = 'gray' }) => {
